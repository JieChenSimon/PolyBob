 ...
 * lives on the instrument's own page instead of at the top of the Crypto tab —
...
export default async function CryptoInstrumentPage({
  ...
  return (
    <Suspense fallback={<div className="mx-auto mt-6 h-32 w-full max-w-shell px-5 md:px-8" />}>
      <InstrumentDetail symbol={decodeURIComponent(symbol).toUpperCase()} domain="altcoin" />
    </Suspense>
  );
}
