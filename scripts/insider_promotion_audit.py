...
def main() -> int:
    candidates = {
        ...
        "market20_extended_hold30_weak0_cap1x": {
            1.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak0_cap1x.json"),
            2.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak0_cap1x_2x.json"),
            3.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak0_cap1x_3x.json"),
        },
        "market20_extended_hold30_weak5_cap1x": {
            1.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak5_cap1x.json"),
            2.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak5_cap1x_2x.json"),
            3.0: Path("data/insider_kernel_replay_extended_market20_hold30_weak5_cap1x_3x.json"),
        },
    }
    audits = {}
    for name, cost_paths in candidates.items():
        ...
        n_trials = 648 if name in {"market20_extended_hold30_delay7_cap1x", "market20_extended_hold30_delay30_cap1x", "market20_extended_hold30_weak0_cap1x", "market20_extended_hold30_weak5_cap1x"} else (324 if name in {"market20_extended_hold30_cap1x", "market20_extended_hold10_cap1x", "market20_extended_hold30_min100k_cap1x"} else int(
