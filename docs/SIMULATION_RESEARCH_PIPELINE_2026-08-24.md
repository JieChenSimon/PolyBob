...
新增 [cross_sectional_local_screen.json](../data/cross_sectional_local_screen.json)，在本地全量日线宇宙上测试预注册的 18 个 long-only 横截面动量组合（20/30/60 日回看，赢家占比 20%/30%，每日/每 5 日/每 10 日换仓），只用当日以前的收益排序并扣除域成本。
